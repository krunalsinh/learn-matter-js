...
function animateFlag() {
  ...
  imageMode(CORNER);
  image(animatedFlagImgRed,
    0,
    0,
    (animatedFlagImgRed.width / maxFrameX) * 0.75,
    (animatedFlagImgRed.height / maxFrameY) * 0.75,
    frameX * (animatedFlagImgRed.width / maxFrameX),
    frameY * (animatedFlagImgRed.height / maxFrameY),
    animatedFlagImgRed.width / maxFrameX,
    animatedFlagImgRed.height / maxFrameY);
}
